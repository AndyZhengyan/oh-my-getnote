...
export default function RightPanel() {
  ...
  return (
    <aside style={{ position: 'fixed', right: 16, top: 64, width: 360, maxHeight: 'calc(100vh - 80px)', background: 'var(--bg-glass)', backdropFilter: 'blur(20px)', border: '1px solid var(--border-dim)', borderRadius: 12, boxShadow: '0 8px 40px rgba(0,0,0,0.5)', overflowY: 'auto', zIndex: 200, display: 'flex', flexDirection: 'column' }}>
      {focusMode && (
