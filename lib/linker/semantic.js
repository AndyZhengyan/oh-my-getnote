...
export async function buildSemanticLinks(notes, threshold = 0.75) {
    if (notes.length < 2)
        return [];
 ...
 */
export async function buildNoteConnections(notes, threshold = 0.5, topK = 8, returnEmbeddings = false) {
    if (notes.length < 2) {
